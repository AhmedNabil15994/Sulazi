...
<div class="kt-portlet kt-portlet--tabs">
    ...
    <div class="kt-portlet__body">
        <form action="{{ URL::to('/groups/update/'.$data->data->id) }}" method="post">
            @csrf
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-9 col-xl-9">
                                            ...
                                            @forelse($data->permissions as $permissionKey => $permissionValue)
                                                <option value="{{$permissionValue}}" {{ $data->data->permissions != '' && in_array($permissionValue, $data->data->permissions) ? 'selected' : '' }}>{{$permissionValue}}</option>
                                            @empty
